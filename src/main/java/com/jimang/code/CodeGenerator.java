...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 全局变量配置
        String projectPath="jimang";
        GlobalConfig gc = new GlobalConfig();
        gc.setOutputDir( "restful/src/main/java"); // 输出路径
...
//        gc.setSwagger2(true); //默认false
        ...
        dc.setUrl("jdbc:mysql://localhost:3306/poc?serverTimezone=CTT&useUnicode=true&characterEncoding=utf-8&useSSL=false");
        ...
        pc.setParent("com.jimang");	//文件生成到哪个目录下
        pc.setModuleName("restful"); //此处是所属模块名称
...
//                        + pc.getModuleName()
        ...
        sc.setInclude("user"); //表名，用，隔开  需要生产
